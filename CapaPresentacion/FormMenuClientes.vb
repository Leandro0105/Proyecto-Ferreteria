...
#End Region
    ...
    Private Sub IconoHome_Click_1(sender As Object, e As EventArgs) Handles IconoHome.Click
        MostrarHome = True
        Me.Close()
    End Sub

    Private Sub PanelSuperior_Resize(sender As Object, e As EventArgs) Handles PanelSuperior.Resize
        AjustarPaneles()
    End Sub
